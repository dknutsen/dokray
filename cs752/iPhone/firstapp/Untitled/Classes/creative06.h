...
Scene* make_scene()
{
  ...
  for(int i=0; i<60; i++){
	  ...
	  world->add_object(new Sphere(
		  ...
		  RPoint(-(float)maxr*0.5f+x,-(float)maxr*0.5f+y,z), 
		  0.3f));
  }
  /*world->add_object(new Sphere(
  ...
  world->add_object(new Plane(new LambertianMaterial(Color(0.8f, 0.8f, 0.8f),
                                                     kd, ka),
                              Vector(0.f, 0.f, 1.f), RPoint(0.f, 0.f, -0.1f)));
  ...
  scene->add_light(new PointLight(RPoint(20.f, -30.f, 100.f),
  ...
  scene->set_camera(new PinholeCamera(RPoint(12.f, -12.f, 7.f),
                                      RPoint(1.f, 1.f, 2.f),
                                      Vector(0.f, 0.f, 1.f),
                                      60.f));
